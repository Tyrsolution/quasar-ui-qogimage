...
function extendConf(conf, api) {
  ...
  if (api.hasWebpack) {
    ...
    transpileTarget.push(/quasar-app-extension-qogimage[\\/]src/)
    transpileTarget.push(/quasar-ui-qogimage[\\/]src/)
  }

  // make sure the stylesheet goes through webpack to avoid SSR issues
  // conf.css.push('~quasar-ui-qogimage/src/index.sass')
}
...
export default function (api) {
  ...
  // api.registerDescribeApi('QOGImage', '~quasar-ui-qogimage/src/components/QOGImage.json')

  // Uncomment the line below if you provide a JSON API for your directive
  // api.registerDescribeApi('q-og-image', '~quasar-ui-qogimage/src/directives/q-og-image.json')
