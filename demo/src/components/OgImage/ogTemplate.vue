<template>
  <div
    ...
    "
    class="w-full h-full text-1.4rem text-white flex flex-col items-center justify-between px-2rem py-2rem"
  >
...
const props = defineProps(['title', 'summary', 'authorName']);
...
const truncatedSummary = truncateString(props.summary, 150);
</script>
